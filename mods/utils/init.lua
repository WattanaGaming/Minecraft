...
---@return string
function utils.get_current_modpath()
    return minetest.get_modpath(minetest.get_current_modname())
end

---@param original table
---@param overrides table
function utils.override_table(original, overrides)
...
function utils.dir_tree(dir, fileHandler)
    ...
    for _,directory in ipairs(directories) do
        utils.dir_tree(dir.."/"..directory, fileHandler)
    end
end
